...
search_file <- "barela_etal_2023_data1.xlsx"
...
reviewed_studies <- read_csv("barela_etal_2023_data2.csv", show_col_types = FALSE) |>
...
dataReporter::makeCodebook(codebook_data, reportTitle = "Codebook for dog impulsivity systematic review data", file = "barela_etal_2023_codebook.Rmd", replace = TRUE)
