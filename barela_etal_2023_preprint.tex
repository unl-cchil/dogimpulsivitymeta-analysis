...
\hypersetup{
  ...
  pdflang={en-EN},
  pdfkeywords={canine, impulsivity, inhibitory control, meta-analysis, self-control},
  hidelinks,
...
\textbf{This preprint has been accepted for publication at the \textit{Journal of Comparative Psychology}. This paper is not the copy of record and may not exactly replicate the authoritative document published in the APA journal. The final article is available, upon publication, at: \href{https://doi.org/10.1037/com0000352}{https://doi.org/10.1037/com0000352}.}

PsyArXiv preprint: \url{https://doi.org/10.31234/osf.io/ctfns}
...
\fontsize{8}{10}\selectfont
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{1.6cm}>{\raggedright\arraybackslash}p{2.3cm}>{\raggedright\arraybackslash}p{1.8cm}>{\raggedright\arraybackslash}p{2.2cm}>{\raggedright\arraybackslash}p{2.2cm}>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{2.1cm}>{\raggedright\arraybackslash}p{1.9cm}>{\raggedright\arraybackslash}p{2.2cm}>{\raggedright\arraybackslash}p{2.3cm}}
\toprule
Task & A-not-B Cup & Buzzer & Cylinder & Detour Fence & Middle Cup & Sit-Stay & Social Inhibition & Wait-for-Treat & DIAS\\
\midrule
...
\leavevmode\vadjust pre{\hypertarget{ref-Blanchard.Hayden.2015}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Gnanadesikan.etal.2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Logan.etal.2022}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Parrish.etal.2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Stevens.2010a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Turner.etal.2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Valentine.etal.2010}{}}%
